...
<div class="panel">
  <div class="panel-head"><h3>用户反馈</h3></div>
  <div class="panel-body">
    <div class="fb-item-head">
      ...
      <div style="flex:1;min-width:0">
        ...
        <div class="fb-item-meta" style="margin-top:3px"><?= e($fb['created_at']) ?> · 点赞 <?= (int)$fb['likes'] ?></div>
      </div>
    </div>
...
<div class="panel">
  <div class="panel-head"><h3>以管理员身份回复</h3></div>
  <div class="panel-body">
    <form method="post" action="<?= u('admin/feedback_view.php?id=' . $fid) ?>">
      ...
      <div style="text-align:right;margin-top:12px">
        <button class="btn btn-primary" type="submit">发布官方回复</button>
      </div>
    </form>
  </div>
</div>
...
<div class="panel">
  <div class="panel-head"><h3>全部回复（<?= count($replies) ?> 条 · 管理员优先展示）</h3></div>
  <div class="panel-body">
    <?php if ($replies): ?>
    ...
    <?php else: ?>
    <div class="empty" style="padding:26px"><div class="empty-icon"></div><p>暂无回复</p></div>
    <?php endif; ?>
  </div>
</div>
