...
$menu = [
    ['index', 'index.php', '仪表盘'],
    ['users', 'users.php', '用户管理'],
    ['sources', 'sources.php', '播放源管理'],
    ['mail', 'mail.php', '邮件推送'],
    ['notice', 'notice.php', '网站公告'],
    ['feedback', 'feedback.php', '反馈管理'],
    ['settings', 'settings.php', '网站设置'],
];
$curMenu = null;
foreach ($menu as $m) {
...
<div class="admin-layout">
  <aside class="admin-side">
    ...
    <?php foreach ($menu as [$key, $file, $label]): ?>
